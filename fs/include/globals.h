...
//#define F_ME  "/feature/ed.c" //定義新的編輯器 by chan
...
// Daemons
#define ADVANCE_ZMUD "/adm/daemons/advance_zmud.c"
...
// 好像沒用了 #define FRIEND_D		"/adm/daemons/friend"
...
#define COMMON_OBJ      "/obj/medicine/"

// 底下的定義會記錄命令的使用/請配合 profile 命令的使用
...
#define MUD_NAME_INTERMUD	"Fantasy Space"
#define MUD_NAME_ABBR		"fs"
#define MUD_HOSTNAME		"fs.twkang.net"
