...
main(object me, string str)
{
        ...
        args = explode(str, " ");
        str = implode(args[1..<0], " ");

        switch(args[0]) {
        case "mkroom"   :       return do_mkroom(str);
        case "rset"     :       return do_rset(str);
        case "uset"     :       return do_set(str);
        case "setlong"  :       return do_setlong(str);
        case "connect"  :       return do_connect(str);
        case "dconnect" :       return do_dconnect(str);
        case "addobj"   :       return do_addobj(str);
        case "delobj"   :       return do_delobj(str);
        case "saveroom" :       return do_saveroom(str);
