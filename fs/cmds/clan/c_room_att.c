...
int main( object me, string arg )
{
	...
	write( "將此" + ( env->query("light_up") ? "光亮" : "漆黑" ) + "區域設為 [1]光亮 [2]漆黑 : " );
	input_to( "ask_light", 0, me );
	return 1;
}
...
void ask_light( string str, object me )
{
	...
	write( "將此" + ( environment(me)->query("outdoors") ? "室外" : "室內" ) + "區域設為 [1]室外 [2]室內 : " );
	input_to( "ask_outdoors", 0, me );
}
