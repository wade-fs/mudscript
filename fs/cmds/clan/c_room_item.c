...
int main( object me, string arg )
{
	...
	if( !CLAN_D->is_clan_room(me) && !wizardp(me) )
		return notify_fail( short + "並非本幫所屬地盤。\n" );
	if( env->query("owner") != me->query("id") && me->query("clan/rank") > 3 )
		return notify_fail( short + "並非您的區域。\n" );
