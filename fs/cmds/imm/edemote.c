...
int main(object me, string arg)
{
        ...
        write("────────────────────────────────────\n");
        write("請先輸入這個emote的中文名稱(如果想不出來就直接用英文吧):\n->");
        input_to("get_msg_name", 0, emote, arg);
        return 1;
}

int get_msg_name(string msg,mapping emote,string pattern)
{
        if (msg==".") {
                write("你放棄了這一次的編輯!!\n");
                return 1;
        ...
        input_to("get_msg_myself", 0, emote, pattern);
        return 1;
}
int get_msg_myself(string msg, mapping emote, string pattern)
{
        if (msg==".") {
                ...
                input_to("get_msg_others", 0, emote, pattern);
                return 1;
        }
...
int get_msg_others(string msg, mapping emote, string pattern)
{
        if (msg==".") {
                ...
                input_to("get_msg_myself_self", 0, emote, pattern);
                return 1;
        }
...
int get_msg_myself_self(string msg, mapping emote, string pattern)
{
        if (msg==".") {
                ...
                input_to("get_msg_others_self", 0, emote, pattern);
                return 1;
        }
...
int get_msg_others_self(string msg, mapping emote, string pattern)
{
        if (msg==".") {
                ...
                input_to("get_msg_myself_target", 0, emote, pattern);
                return 1;
        }
...
int get_msg_myself_target(string msg, mapping emote, string pattern)
{
        if (msg==".") {
                ...
                input_to("get_msg_target", 0, emote, pattern);
                return 1;
        }
...
int get_msg_target(string msg, mapping emote, string pattern)
{
        if (msg==".") {
                ...
                input_to("get_msg_others_target", 0, emote, pattern);
                return 1;
        }
