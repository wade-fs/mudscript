...
int main(object me, string arg)
{
  ...
  if(me->query_temp("wait_buy"))
    return notify_fail("賣東西的人正在忙, 等下再買吧!!!\n");
  else
  {
    me->set_temp("wait_buy",1);
    call_out("delay_buy",2,me);
  }
