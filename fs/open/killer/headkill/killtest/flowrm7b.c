//花園迷陣第七型房間，正確方向是南方
//因為面對北邊，遇到三棵夾竹桃，基本上遇到夾竹桃應該往兩棵的走
//但是，因為附近有兩個兩棵，所以根據十丈反左
//找石頭，在十丈外的西方有石頭，所以往西方的左邊找去，就是在南邊
inherit ROOM;
string npc_name;
void create()
{
 ...
 if(interactive(me = this_player()))
 {
  switch(i)
  {
	case 0:
	{
		...
		guard->move("/open/killer/headkill/killtest/flowrm7b.c");
		npc_name="ice river";
		break;
	}
	case 1:
...
int do_move(string arg)
{
 ...
 if(present(npc_name,environment(me))) 
  ...
  if ((arg == "west") || (arg == "north") || (arg == "east"))
  {
