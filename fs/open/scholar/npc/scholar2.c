...
carry_object("/open/scholar/obj/s_armband")->wear();
carry_object("/open/scholar/obj/s_helmet")->wear();
carry_object("/open/scholar/obj/s_boots")->wear();
}
