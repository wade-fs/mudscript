...
void create() {
	...
	set( "object", ([
		...
		"file10"   : "/open/killer/outsea/dstone",
	...
	set( "build", 10011 );
	set( "exits", ([
		"west"      : "/open/clan/sky-wu-chi/room/room415.c",
		"south"     : "/open/clan/sky-wu-chi/room/room416",
		"north"     : "/open/clan/sky-wu-chi/room/room416",
		"east"      : "/open/clan/sky-wu-chi/room/room417.c",
	]) );
	set( "long", @LONG
