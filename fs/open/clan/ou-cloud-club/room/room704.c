...
void create() {
	...
	set( "build", 10906 );
	set( "exits", ([
		"east"      : "/open/clan/ou-cloud-club/room/room703.c",
		"west"      : "/open/clan/ou-cloud-club/room/room705.c",
		"south"     : "/open/clan/ou-cloud-club/room/room708.c",
		"north"     : "/open/clan/ou-cloud-club/room/room712",
	]) );
	set( "light_up", 1 );
	set( "long", @LONG
