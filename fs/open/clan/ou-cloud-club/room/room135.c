...
void create() {
	...
	set( "build", 11668 );
	set( "exits", ([
		"east"      : "/open/clan/ou-cloud-club/room/room470.c",
		"west"      : "/open/clan/ou-cloud-club/room/room108",
		"south"     : "/open/clan/ou-cloud-club/room/room125.c",
...
東邊是趴趴熊(panda)的窩，西邊是邪神(sula)的邪神居。
