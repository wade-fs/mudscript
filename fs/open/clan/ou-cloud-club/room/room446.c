...
void create() {
	...
	set( "light_up", 1 );
	set( "exits", ([
		"south"     : "/open/clan/ou-cloud-club/room/room247",
		"west"      : "/open/clan/ou-cloud-club/room/room447.c",
		"east"      : "/open/clan/ou-cloud-club/room/room445.c",
		"north"     : "/open/clan/ou-cloud-club/room/room449",
	]) );
	set( "long", @LONG
...
北邊是瀟瀟(Legendpker)的瀟瀟房，南邊是歸元(circle)的歸元村。
