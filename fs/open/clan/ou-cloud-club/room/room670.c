...
void create() {
	...
	set( "light_up", 1 );
	set( "exits", ([
		"north"     : "/open/clan/ou-cloud-club/room/room658",
		"west"      : "/open/clan/ou-cloud-club/room/room669.c",
		"east"      : "/open/clan/ou-cloud-club/room/room671.c",
	]) );
	set( "long", @LONG
