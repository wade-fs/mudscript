...
void create() {
	...
	set( "build", 10421 );
	set( "exits", ([
		"west"      : "/open/clan/dark-forest/room/room23",
		"north"     : "/open/clan/dark-forest/room/room26.c",
		"south"     : "/open/clan/dark-forest/room/hall.c",
		"east"      : "/open/clan/dark-forest/room/room27.c",
	]) );
	set( "long", @LONG
