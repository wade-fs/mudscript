...
{
  seteuid(getuid());
  set_name("人靈草",({"human item","item"}));
  set("long",
    "此乃崑崙山上最為出名的三聖草之一「人靈草」，聽說所練製出來的丹藥，據有起死回生的\n"+
    "功能，此物須經過醫者精湛的醫術方可提煉。\n");
  set("unit", "棵");
  set("base_unit", "棵");
  set("no_sell",1);
...
//      message_vision("$N試著將人靈草製成靈丹。\n", user);
      ...
      message_vision("$N的醫術太低，無法將人靈草製成靈丹。\n", user);
    return 1;
  }
  return 0;
}
