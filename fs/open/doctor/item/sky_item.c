...
{
  seteuid(getuid());
  set_name("天靈草", ({"sky item","item"}) );
  set("long",
    "此乃昆崙山上最為出名的三聖草之一「天靈草」，傳說此草吸盡天地靈氣，對於身受內創的\n"+
    "人，能將受的內創消除，此物須經過醫者精湛的醫術方可提煉。\n");
  set("unit", "棵");
  set("base_unit", "棵");
  set("no_sell",1);
  set("value",2500);
...
//      message_vision("$N試著將天靈草製成靈丹。\n", user);
      ...
      message_vision("$N的醫術太低，無法將天靈草製成靈丹。\n", user);
    return 1;
  }
  return 0;
}
