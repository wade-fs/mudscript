...
void create()
{
  ...
  set("chat_msg", ({
    ...
    (: random_move :),
    (: random_move :),
    "阿三說道﹕怎麼會這樣呢，以前只有我在挑水的時候還不覺得複雜，怎人一多就…\n",
	"阿三說道﹕寺裡的水快用完了，我應該一個人去就好，雖然辛苦了點，唉～\n",
	"阿三說道﹕我是不是該獨自去挑水呢…\n",
	"阿三說道﹕一根扁擔兩個頭，只要他們其中一位讓一下就不會這麼麻煩了，唉～\n",
	"阿三說道﹕一根扁擔兩個頭，他們人太好了所以才會跟我爭挑水的工作，唉～\n",
	"阿三說道﹕唉～為什麼他們都不讓步呀…\n"}));
  set("inquiry", ([
	"心結"      : (: ask_dispute :),
	"苦惱"      : (: ask_dispute :),
...
{
  message_vision("阿三對$N搖搖手指說﹕$N一邊玩去，和尚我快下定決心去挑水了。\n",who);
  return notify_fail("");
}
