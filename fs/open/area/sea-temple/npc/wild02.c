...
void create()
{
        ...
        set("long","野人村來的獸人，智慧比粗野人高一點，只會按照上面所吩咐下來作事情。\n");
        set("race","野獸");
...
string *break_msg = ({
	HIR + "野人不斷飛舞著鐵鎚般的拳頭，敲向周圍還佇立著的圍牆！\n" + NOR,
	HIR + "野人不斷的破壞著圍牆！\n" + NOR,
	HIR + "野人一邊留著口水，一邊敲打著周圍的牆壁！\n" + NOR,
	HIR + "野人用力敲了牆壁後，發覺手很痛，皺了一下眉頭後，又繼續敲打牆壁！\n" + NOR,
	HIR + "野人緩緩的觀看了四周，又繼續敲打牆壁！\n" + NOR,
});
