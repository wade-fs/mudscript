...
{
      message_vision(HIB+"水龍背後掀起了一陣濤天的巨浪 ,正朝著$N迅速狂捲而去!!\n"+NOR,enemy[i]);
      message_vision(HIC+"$N閃躲不及 ,被洶湧的波濤捲得奄奄一息。\n"+NOR,enemy[i]);
  ...
  COMBAT_D->report_status(enemy[i], 1);
      ...
      message_vision(HIB+"水龍的背後掀起了一陣濤天的巨浪 ,正朝著$N迅速狂捲而去!!\n"+NOR,enemy[i]);
     message_vision(HIW+"只見$N飛身側閃 ,輕輕避開水龍的攻擊...\n"+NOR,enemy[i]);
