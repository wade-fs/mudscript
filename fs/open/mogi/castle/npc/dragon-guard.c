...
void create() {
	...
	set_name("青龍守衛",({"dragon guard","guard"}));
	set("long",
	    "\n他是鎮守青龍室的妖魔。\n");
...
{
return notify_fail("青龍守衛說道 : 我沒空陪你玩。\n");
}
...
{    
	...
	j=random(-1);
	  ...
	  {      
	  new("/open/sky/obj7/dragon-order")->move(environment(winner));
	  message_vision(HIM + "\n從青龍守衛的身上掉下了一件奇怪的東西!!\n" + NOR,winner);
          write_file("/log/sky/obj7/dragon_order",sprintf("%s(%s) 讓青龍守衛掉下了青龍結令於 %s\n",
