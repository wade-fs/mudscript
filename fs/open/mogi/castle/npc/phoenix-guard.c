...
void create() {
	...
	set_name("朱雀守衛",({"phoenix guard","guard"}));
	set("long",
	    "\n他是厲害妖魔。\n");
...
{
return notify_fail("朱雀守衛說道 : 我沒空陪你玩。\n");
}
...
{    
	...
	j=random(-1);
	  ...
	  {      
	  new("/open/sky/obj7/phoenix-order")->move(environment(winner));
	  message_vision(HIM"\n從朱雀守衛的身上掉下了一件奇怪的東西!!\n"NOR,winner);
          write_file("/log/sky/obj7/phoenix_order",sprintf("%s(%s) 讓朱雀守衛掉下了朱雀結令於 %s\n",
