...
set_name("飛燕",({"fay-yen"}));
set("long","
男塾三面拳之一，外型十分俊俏，絕招為鶴嘴千本\n");
set("gender","男性");
set("class","fighter");
set("combat_exp",30000000);
set("attitude","heroism");
set("title",""HIW"男塾三面拳"NOR"");
set("nickname",""HIM"俊"NOR);
set("no_fight",1);
set("no_kill",1);
set("no_plan",1);
set("age", 25);
...
set("kar", 30);
set("score",9000000);
set_skill("chadsk",100);map_skill("unarmed","chadsk");
set("kee",10000000);
...
int do_reveal(string str)
{
    ...
    if((obj2->query("id")=="lay-mark")||(obj2->query("id")=="yua-mark")){
       write("你從身上拿出"+obj2->query("name")+"給"+obj->query("name")+"看，只見"+obj->query("name")+"看的入神.\n");
       ppl->set_temp("show-to-fay",1);
       call_out("msg1",0,ppl);
