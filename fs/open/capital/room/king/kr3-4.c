// Room: /open/capital/room/king/kr3-4
#include <ansi.h>
inherit ROOM;
...
void create ()
{
  set ("short", "皇城禁地");
  set ("long", @LONG
這兒就是大內皇城禁地, 在此地不得大肆喧嚷, 南方的階梯即通往
朝聖殿, 在附近時常有禁衛軍在巡邏, 往北走可通往永德殿, 往西走可
通往太尉府.
LONG);
  ...
  set("no_transmit", 1);
  set("exits", ([ /* sizeof() == 2 */
  "north" : "/open/capital/room/king/kr2-4",
  "west" : "/open/capital/room/king/kr3-3",
]));
