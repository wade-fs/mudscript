// Room: /open/capital/room/king/kr6-6
#include <ansi.h>
inherit ROOM;
...
void create ()
{
  set ("short", "皇城禁地");
  set ("long", @LONG
這兒就是大內皇城的廣場, 這裡的視野十分遼闊, 此地不得大肆喧
譁, 往北走可通往明和園, 往西走可通往皇宮大門
LONG);
  ...
  set("exits", ([ /* sizeof() == 2 */
  "west" : "/open/capital/room/king/kr6-5",
  "north" : "/open/capital/room/king/kr5-6",
]));
