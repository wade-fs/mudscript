...
//  set("kee",15000);
  ...
  carry_object("/open/capital/obj/blade2")->wield();
...
int do_cmd(string str) {
  ...
  if(str=="askgod king" || str=="askgod guard" || str=="askgod king guard") {
    who->start_busy(2);
    message_vision("$N忽然大喝一聲，$n當場被嚇得魂飛魄散，內力也因此大打折扣!!\n",me,who);
