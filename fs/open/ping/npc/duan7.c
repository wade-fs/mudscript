...
void create()
{
        ...
        set("long","段七是段雲的義子, 是段雲二十年前自山道旁撿來的嬰兒, 因為那"+
"天是大年初七, 所以便取名為段七。\n");
        set("gender","男性");
        set("class","scholar");
        ...
        set("chat_chance", 5);
        set("chat_msg", ({
        "段七說: 唉....凌波微步的步法真是複雜, 搞得我頭都暈了。\n",
        "段七說: 義父給我的這捲軸真是怪異, 上頭的步法都看不懂。\n"
        }));
        set("age",20);
        set("inquiry", ([
        "thief" : "什麼賊不賊的, 沒看到我正專心練「凌波微步」嗎﹖",
        "scar" : "唉..別煩我, 沒看過這種人啦",
        "sad_story" : "義父的事﹖嗯..不清楚..。",
        "凌波微步秘笈" : (: do_linpo :),
        ]));
        set("force",500);
        set("max_force",500);
