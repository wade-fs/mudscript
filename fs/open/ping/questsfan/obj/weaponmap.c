...
#define C_BOOK_NAME ""HIC"飄陽扇武器設計圖"NOR""
...
void create()
{
  ...
  set( "long", "這是一張由前輩高手北勝天用盡心血所書寫的飄陽扇設計圖，你可以用(read)來觀看。\n");
...
int do_read( string arg )
{
       ...
       tell_object(me,"上面的文字寫的太深奧，你根本看不懂。\n");
       return 1;
}
...
{
  object me = this_player();
  object fan=new("/autoload/scholar/finger_fan.c");
  string record,file;
