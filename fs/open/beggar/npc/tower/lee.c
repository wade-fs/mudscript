...
void die()
{
    ...
    tell_object(winner,"你從李豔萍身上割下一粒人頭。\n");
    ob=new("/open/beggar/obj/lee-head");
    ob->move(winner);
    winner->set_temp("ko_lee",1);
