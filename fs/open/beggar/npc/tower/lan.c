...
{
  this_object()->set_temp("wielded",1);
...
void die()
{
    ...
    tell_object(winner,"你從刑速蘭身上割下一粒人頭。\n");
    ob=new("/open/beggar/obj/lan-head");
    ob->move(winner);
    winner->set_temp("ko_lan",1);
