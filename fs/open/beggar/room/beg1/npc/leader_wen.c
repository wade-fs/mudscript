...
void create()
{
        set_name("雲中仙",({"wen leader","wen","leader"}));
        set("long","他是丐幫布袋長老中的一員！\n");
        set("gender","男性");
        set("class","beggar");
        set("nickname",HIY"乞中神仙"NOR);
...
//      set("chat_chance",2);
        ...
        set("chat_msg", ({
            ...
            HIC"雲中仙無奈道：今天又討不到東西了, 真煩！\n"NOR,}));
        setup();
carry_object("/open/beggar/obj/gstaff.c")->wield();
carry_object("/open/beggar/obj/hands.c")->wear();
carry_object("/open/beggar/obj/boots.c")->wear();
}
...
int accept_kill (object who)
{
  ...
  command ("wear all");
  command("perform pkdog-staff.skydog");
  return 1;
}
