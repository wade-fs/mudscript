//補上線索與更正錯字 by blazakira 2010/12/12
#include <room.h>
#include <ansi.h>
inherit ROOM;
void create ()
...
{
  mapping heads = ([
  "lan-head in 木" : 1, //刑速蘭的人頭(Lan-head) (/open/beggar/obj/lan-head) 刑命屬金
  "liung-head in 土" : 2, //梁志勇的人頭(Liung-head) (/open/beggar/obj/liung-head) 梁命屬木
  "lee-head in 水" : 3, //李豔萍的人頭(Lee-head) (/open/beggar/obj/lee-head) 李命屬土
  "chung-head in 火" : 4, //疆屍的人頭(Chung-head) (/open/beggar/obj/chung-head) 疆命屬水
  "pin-head in 金" : 5, //方平的人頭(Pin-head) (/open/beggar/obj/pin-head) 方命屬火
  "cow-head in 心" : 6, //鬥牛的人頭(Cow-head) (/open/beggar/obj/cow-head) 鬥者無心
  "hung-head in 人" : 7, //黃秋生的人頭(Hung-head) (/open/beggar/obj/hung-head) 黃生非人
                   ]);
  mapping heads2 = ([
  "lan-head in 金" : 1, //刑速蘭的人頭(Lan-head) 刑命屬金
  "liung-head in 木" : 2, //梁志勇的人頭(Liung-head) 梁命屬木
  "lee-head in 土" : 3, //李豔萍的人頭(Lee-head) 李命屬土
  "chung-head in 水" : 4, //疆屍的人頭(Chung-head) 疆命屬水
  "pin-head in 火" : 5, //方平的人頭(Pin-head) 方命屬火
                   ]);
  ...
  if(ob->query_temp("can_put") != 1)
    return notify_fail("你沒有得到老先生的允許\！\n");
  ...
  {
   message_vision(HIY + "糟糕！你搞錯五行相生相剋的關係！\n" + NOR,ob);
   ob->unconcious();
  }
  else if(heads[str])
  {
...
void do_staff11()
{
  ...
  tell_object(users(),HIW + "
                ...
                費盡心力，終於拿到" + HIC + "稀世珍寶了" + HIW + "！
                    
                     以後我將以此來俠義武林！\n\n" + NOR);
   me->move("/open/beggar/room/q1");
}
