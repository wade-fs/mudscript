...
mapping *action = ({
([ "action" : "$N使出絕情大法第一招"+HIG+"【風】"+NOR+"，$N舉起手，口中喃喃唸咒文，此時$n的四周刮起強風，將$n包圍，且像刀般鋒利攻向$n的$l攻去。",
                "damage":300,
                "post_action":  (: bleed :),
                "damage_type":   "割傷",]),
([ "action" : "$N使出絕情大法第二招"+HIR+"【火】"+NOR+"，$n舉起手，口唸咒文，此時地上冒出地獄之火向$n的$l燒去。",
                "damage":300,
                "post_action":  (: block :),
                "damage_type":   "燒傷",]),
([ "action" : "$N使出絕情大法第三招"+HIY+"【雷】"+NOR+"，$N舉起手，口唸咒文，突然雷聲大作，讓$n呆了一陣。",
                "damage":300,
                "post_action":  (: suck :),
                "damage_type":   "震傷",]),
([ "action" : "$N使出絕情大法第四招"+HIB+"【電】"+NOR+"，$N舉起手，口唸咒文，天空聚集一電柱向$n射去。",
                "damage":300,
                "post_action":  (: bleed :),
                "damage_type":   "刺傷",]),
...
void create()
{
 set_name("林楓",({"fon"}));
 set("nickname","絕情門主");
 set("long","他在一位絕情門門主，是名震塞外的門派，自創絕情神指，非常厲害
，聽說他有本「絕情大法秘笈」。\n");
 set("gender","男性");
...
void heart_beat()
{
 ...
 if( random(70) < 15)
 {
    ...
    {
     message_vision(HIW+"$N看見林楓，祭起"+HIY+"「絕情訣」"+HIW+"以精化氣，以
氣御神，以神聚力，只見林楓的"+HIR+"手臂通紅"+HIW+"，
直向$N的"+HIR+"心臟"+HIW+"抓來，你頓時"+HIR+"血液流了不少\n"+NOR,
target);
