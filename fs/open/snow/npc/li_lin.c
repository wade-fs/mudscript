...
string ask()
{
	if( this_player()->query("quests/to-kill-2") != 1 )
		return "這個人我有聽過﹐他好像是二十年前的一位名人。\n";
	this_object()->set("title","黑仙羅漢");
...
void create()
{
	...
	set("inquiry",([
	"黑仙羅漢" : (: ask :),
		"後山" : "後山是本派的禁地﹐是本派關犯人之地。\n",
		"後山密室" : "後山的密室中似乎關了一個重要的犯人在裡面。\n",
		]));
            set("force_factor",20);
          set_skill("dodge",40);
            set_skill("force",50);
...
void die()
{
	...
	if( this_object()->query("title")!="黑仙羅漢" )
		::die();
