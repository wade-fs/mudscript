...
string back_up()
{
	...
	if( me->query("quests/back-young") ) 
			return "我不明白你想穿梭時空幹嘛 ?";
	command("say 你想穿梭時空 ? 要花費一甲子的內力哦(上限-60) ? 考慮考慮吧 ?");
...
void create()
{
	set_name("倪可姬",({"taoist"}));
	set("title","茅山派第六代弟子");
	set("long","他是茅山派的叛徒﹐私自盜取了茅山派的至寶金麟蟒邪及天羅寶策下山。\n");
		set("gender","男性");
