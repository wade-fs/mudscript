...
LONG);
        ...
        set("inquiry",([
                "獨孤愁" : "獨孤愁乃是家父﹐已經仙逝多時了 ...\n",
                "仙逝" : "家父是為了鍛練雪蒼派不傳神功而走火入魔 ... 唉 . ...\n",
                "去老還童術" : "那是一種十分微妙的一種功夫﹐相傳修練這種功夫必需練到極限﹐才能夠返老還童﹐據我所知﹐這種功夫十分難練﹐而且會的人不多。\n",
                "會的人" : "據我所知﹐只有我爹爹有練過這種功夫但是並沒有練到極限﹐可惜 ...\n",
                "可惜" : "可惜我爹爹已經仙逝了﹐而且也沒有留下什麼秘笈﹐所以這部功夫也就因此失傳了。\n",
                "秘笈" : "我爹爹去逝後只有留下幾樣家傳寶貝﹐天誅筆、穿龍劍等等﹐並沒有什麼秘笈留下。\n",
                "天誅筆" : "這是我家傳的寶貝之一﹐這隻筆相當神奇﹐不用墨水就能寫字哦。\n",
                "穿龍劍" : "這是我家傳的寶貝﹐能夠削鐵如泥﹐而且如果配上穿龍劍法﹐更是威力無窮。\n",
                "寒冰掌" : "家父生前曾經教過我這部功夫﹐但是不能外傳他人﹛M果你能幫我找到﹐我就教你寒冰掌。\n",
                "除非" : "雲畢生最大憾事乃是失落了爹爹生前所著的詩文集﹐如果你能幫我找到﹐我就教你寒冰掌。\n",
                "黑仙羅漢" : "此人嘛 ? .. 我略有所聞﹐此中H早在二十年前就威鎮江湖﹐\n      他的武功不弱﹐但是自從敗在我爹爹手下﹐就消失武林。\n      我想劉掌門應該更清楚他的來歷。\n",
                "劉玲慧" : (: linhwi :),
                "天靈石" : (: pearl :),
