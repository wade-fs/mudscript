...
void create()
{
        set_name(HIM"泥巴星球發獃護膝"NOR,({"Server_legging","legging"}));
        set_weight(2000);
        if( clonep() )
        ...
        set("value",0);
        set("material","steel");
        set("long","傳說中泥巴星球發獃時的流的口水所製成，具強大的防禦力。\n");
set("wear_msg","$N穿上$n，感覺到自己擁有了強大的防禦力。\n");
set("remove_msg","$N想到$n是口水作的，哇啦哇啦地吐了滿地。\n");
        set("no_auc",1);
        set("no_sell",1);
        set("no_give",1);
        set("no_put",1);
