//修正玩家離線時所出現的判斷錯誤 by blazakira 2011/6/23
...
void create()
{
  set("short","水靈塔七樓");
  set("build", 2 );
  set("long","水靈塔的鎮塔之王，正坐鎮於此，四周的空間完全的密閉看來你
已經沒有地方可以逃了，拿出你的本事和水靈塔王拼了吧!!\n");
...
int close()
{
  ...
  if( me && me->query_temp("magic-manor/breakwater") )
  {
...
//  me=this_player();
  ...
  if( dir=="out" && me && me->query_temp("magic-manor/breakwater") )
    me->delete_temp("magic-manor/breakwater");
