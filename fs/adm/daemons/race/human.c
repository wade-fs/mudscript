...
//初期時由於新手的血(100)很少,造成易死的情況常常發生,因此我將氣的部份小小提高到 220左右//

        if( userp(ob) || undefinedp(my["max_gin"]) ) {
                if( my["age"] <= 14 ) my["max_gin"] = 150; //從 100 -> 150
...
// 經驗值的部份.......
        ...
        if( userp(ob) || undefinedp(my["max_sen"]) ) {
                if( my["age"] <= 30 ) my["max_sen"] = 150; //從100 -> 150
...
//              if( my["max_mana"] > 0 ) my["max_sen"] += my["max_mana"] / 4;
        ...
        switch(ob->query("class")) {
          case "bandit":
            my["max_kee"]  = my["max_kee"] * 110 / 100;
            break;
          case "fighter":
            my["max_kee"]  = my["max_kee"] * 150 / 100;
            break;
          case  "dancer":
            my["max_gin"] = my["max_gin"] * 150/100;
            break;
          case  "taoist":
            my["max_sen"] = my["max_sen"] * 150/100;
            break;
          case "doctor":
            my["max_kee"]  = my["max_kee"] * 120 / 100;
            my["max_gin"] = my["max_gin"] * 120/100;
            my["max_sen"] = my["max_sen"] * 120/100;
            break;
