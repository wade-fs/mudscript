...
mapping *action = ({
([ "action":"$N手中$w一揮，使出一招『金蛇出洞』，氣勢驚人，直撲$n而去",
        "dodge": -20,
        "parry": 25,
        "damage": 50,
        "damage_type":  "鞭傷",
...
([ "action":"$N使出一招『靈蛇八方』，$w似靈蛇般由四面八方打向$n",
        "dodge": -15,
        "parry": 35,
        "damage": 45,
        "damage_type":  "鞭傷",
...
([ "action":"$N使出一招『靈蛇乍現』，$w忽隱忽現，忽東忽西，令$n無法捉摸$N的鞭路",
        "dodge": 10,
        "parry": 40,
        "damage": 40,
        "damage_type":  "鞭傷",
...
([ "action":"$N蓄勢一揮，使出一招『赤龍翻江』，呼的一聲，手中$w向$n橫掃而去",
        "dodge": -15,
        "parry": 25,
        "damage": 55,
        "damage_type":  "鞭傷",
...
([ "action":"$N揮動$w，使出一招『金蛇萬道』，如有千百條金蛇同時打出，直撲$n各大穴",
        "dodge": -10,
        "parry": 35,
        "damage": 60,
        "damage_type":  "鞭傷",
...
([ "action":"$N手中$w一抖，圈起一圈圈鞭花，一招『金蛇纏身』，向$n捲去",
	"dodge": 35,
        "parry": 50,
    "damage": 70,
        "damage_type":  "鞭傷",
...
([ "action":"$N身形一斜，使出一招『萬蠱蝕心』，頓時滿天鞭影，鞭勢挾帶一股腥風向$n撲至",
        "dodge": 20,
        "parry": 45,
     "damage": 80,
        "damage_type":  "鞭傷",
...
([ "action":"$N$w微揮，使出一招『幽冥幻化』，
使鞭之快不見鞭影，只聞呼呼聲響，邪風陰煞，圍繞$n四周",
        "dodge": 25,
        "parry": 50,
    "damage":80,
        "damage_type":  "鞭傷",
