...
{
/*
if((int)me->query("combat_exp") <= ((int)me->query_skill("fire-kee")*6) )
   return notify_fail("你的戰鬥經驗不足﹐無法體會烈日護身氣勁運行之道。\n");
*/
       if(me->query_skill("haoforce",1) < 60)
 {
   write("你的浩日心法不夠純熟..無法學習烈日護身氣勁\n");
   return 0;
 }
return 1;
}
...
{
           return CLASS_D("fighter")+"/fire-kee/"+action;
}
