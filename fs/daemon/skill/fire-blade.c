...
//9
  (["action"     : HIW + "$N內勁一吐，使出" + HIM + "「朽木可雕」" + HIW + "，把所有真氣貫注於$w" + HIW + "，往$n飛射而去\n"
...
//10
  (["action"     : HIW + "$N內勁狂吐，使出" + HIM + "「披荊斬蕀」" + HIW + "，運轉了十成功\力，分別注於左掌與$w" + HIW + "，眼見\n"
...
//11
  (["action"     : HIC + "$N加運內息，逆轉筋脈，使出" + HIB + "「杯水車薪」" + HIC + "，只見出招無一順序，由後而前，由下而上\n"
...
//12
  (["action"     : HIC + "$N使出燃木刀法精華，一招" + HIW + "「火樹銀花」" + HIC + "，以慢制快，以輕馭重，以柔剋剛，加上雄厚的內勁\n"
