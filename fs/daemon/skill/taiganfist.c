...
(["action":
HIY + "$N頓時領悟了「" + HIC + "陰" + HIR + "陽" + NOR + "循環，" + HIB + "生生不息" + NOR + "」的道理，將陰陽掌法融合後狂擊而出" + NOR,
"dodge":-100,
"parry":100,
"force":90,
"damage":40,
...
(["action":
"$N頓悟「" + HIC + "陰" + HIR + "陽" + NOR + "合壁，地動天驚」之精義，左右兩掌將陰陽氣勁揉合後拍出，瞬間形成一龍捲風襲向$n。\n",
"dodge":-500,
"parry":-500,
"force":0,
"damage":-100,
