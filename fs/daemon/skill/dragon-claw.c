...
mapping *action = ({
//1
  (["action"     : HIW + "$N" + HIW + "凝氣於掌，掌變化成爪，一招" + HIR + "「雙龍吐珠」" + HIW + "，雙爪有如靈龍搶珠般，飛快的\n"
...
//2
  (["action"     : HIW + "$N" + HIW + "一招" + HIR + "「蟠龍鎖關」" + HIW + "單爪直下，帶者猛烈的剛氣，順沿著$n" + HIW + "的攻勢，反客為主的封鎖住\n"
...
//3
  (["action"     : HIW + "$N" + HIW + "暗運內息，一招" + HIM + "「龍鳳呈祥」" + HIW + "，左爪右掌分別擊向$n" + HIW + "的弱點，$n顧此失彼拆卸了\n"
...
//4
  (["action"     : HIW + "$N" + HIW + "跳躍而起，身形輕盈，一招" + HIM + "「九天龍吟」" + HIW + "雙掌從四面八方齊攻而下，氣勢有如狂風大浪般\n"
...
//5
  (["action"     : HIW + "$N" + HIW + "氣沉丹田，側身一翻，一招" + HIG + "「狂龍捲浪」" + HIW + "雙爪凜烈，圍繞著$n" + HIW + "伺機給予重擊，瞬間$N" + HIW + "看\n"
...
//6
  (["action"     : HIC + "$N" + HIC + "穩固下盤，真氣運走全身，一招" + HIG + "「虎掌生風」" + HIC + "雙掌凝勁，$N" + HIC + "見機行事呼哮的擊出\n"
...
//7
  (["action"     : HIC + "$N" + HIC + "吐納內息，伺機而動，眼見$n" + HIC + "內息不繼，氣喘噓噓，一招" + HIB + "「荒山虎嘯」" + HIC + "，毫不猶豫的手肘\n"
...
//8
  ...
  (["action"     : HIC + "$N" + HIC + "急吐內勁，運轉周天，一招" + HIB + "「臥龍在野」" + HIC + "，$n" + HIC + "看其氣勁似柔似軟，運起氣勁，硬是要把其\n"
...
//9
  (["action"     : HIC + "$N" + HIC + "氣轉至雙爪，一招" + HIY + "「蛟龍出水」" + HIC + "，雙爪帶鉤，由下而上，由後至前，向$n" + HIC + "猛攻而去\n"
...
//10
  (["action"     : HIC + "$N" + HIC + "運起全身功\力，氣勁遊走全身，不吐不快，一招" + HIY + "「金龍攫珠」" + HIC + "，挾帶強大力勁往$n" + HIC + "身上擊出\n"
