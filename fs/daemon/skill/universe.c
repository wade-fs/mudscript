...
void sp1(object me, object victim, object weapon, int damage)
{
// 因為改成能自選出招大家一定都用第五招那跟只寫一招有什分別呢?
// 所以修正威力都差不多讓大家有選則的意願 by swy
if(me->query("env/天驚地動")==1) {
