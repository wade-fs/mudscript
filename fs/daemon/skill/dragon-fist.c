...
//5
([ "action":HIR + "$N" + NOR + "運足十成功\力，身形緩慢推動，倏地間雙掌順勢一推，一式" + HIG + "【" + HIY + "突如其來" + HIG + "】" + NOR + "彷如破天之勢，
...
//10
([ "action":HIW + "$n只感一股極大力量排山倒海般將至，急運功\抵擋。卻見" + HIR + "$N" + NOR + "掌收於胸，" + HIG + "【" + GRN + "見龍在田" + HIG + "】" + NOR + "招
...
//12
([ "action":HIR + "$N" + NOR + "想起師父所言，若是雙方武功\都到了爐火純青的地步，往往對戰數日，仍是難分上下，唯
