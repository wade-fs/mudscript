...
//12
       ([ "action" :
"$N聚集九天之氣，使出【三斬歸元～邪龍斬元】\n"
"．．．『" + HIY + "魔" + HIC + "龍" + HIY + "嗜" + HIC + "血" + HIW + "～～" + HIR + "焚" + HIW + "天" + HIB + "邪" + HIC + "月" + HIW + "』．．．\n"
...
//13
([ "action" :
"$N運用九地之氣，使出【三斬歸元～魚龍嗜元】\n"
"．．．『" + HIY + "魚" + HIC + "龍" + HIY + "毒" + HIC + "鴆" + HIW + "～～" + HIY + "煌" + HIM + "嵐" + HIG + "叢" + HIR + "滅" + HIW + "』．．．\n"
...
//14
([ "action" :
"$N施展九人之氣，使出【三斬歸元～雪影化元】\n"
"．．．『" + HIY + "狂" + HIC + "龍" + HIY + "怒" + HIC + "震" + HIW + "～～" + HIC + "雪" + HIM + "影" + HIB + "寒" + HIC + "霜" + HIW + "』．．．\n"
