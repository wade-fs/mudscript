...
mapping *action = ({
        ([      "action":               "$N使出聖火奇功\[1;37m『[31m絆[37m』[0m字訣，手中$w迅速狂掃向$n下盤﹗",
                "damage":               50,
                "force":            50,
	    "dodge":		-40,
	    "parry":		-40,
        ...
        ([      "action":               "$N使出聖火奇功\[1;37m『[31m劈[37m』[0m字訣，手中$w從空往下狠劈向$n的$l﹗",
                "damage":               70,
                "force":            70,
	    "dodge":		-50,
                "parry":                    -50,
        ...
        ([      "action":               "$N轉動手中$w，霎時[1;37m『[31m轉[37m』[0m字訣隨棍而出閃電般擊向$n的$l﹗",
                "damage":               90,
                "force":            90,
	    "dodge":		-35,
	    "parry":		-35,
        ...
        ([      "action":               "$N揮動$w使出聖火奇功\[1;37m『[31m封[37m』[0m字訣，霎時一陣棍雨飛擊$n的$l﹗",
                 "damage":               100,
	                "force":            100,
     "dodge":		-30,
	     "parry":		-30,
        ...
        ([      "action":               "$N突然身影晃動，使出[1;37m『[31m挑[37m』[0m字訣，手中$w由下往上抖向$n的$l﹗",
                "damage":               110,
                "force":            110,
                "dodge":                -30,
                "parry":                 -30,
        ...
        ([      "action":               "$N使出[1;37m『[31m戳[37m』[0m字訣，只見手中$w化成團碧影，棍雨猛戳向$n的$l﹗",
                "damage":               120,
                "force":            120,
                "dodge":                -25,
                "parry":                  -25,
        ...
        ([      "action":               "$N握住$w，使出[1;37m『[31m引[37m』[0m字訣，棍隨$n的攻擊順而點往$n的$l﹗",
                "force":            150,
                "damage":               150,
                "dodge":                -20,
                "parry":                  -20,
        ...
        ([      "action":               "$N舞動$w使出[1;37m『[31m纏[37m』[0m字訣，迅速使出一陣棍網猛擊$n的$l﹗",
                "damage":              180,
                "force":            180,
                "dodge":                -20,
                "parry":                  -20,
        ...
        ([      "action":               "$N手中$w一舉，使出了[1;37m『[31m怒火九重天[37m』[0m綿延不斷的使出攻向$n的$l",
                "damage":              200,
                "force":            200,
                "dodge":                -10,
                "parry":                  -10,
