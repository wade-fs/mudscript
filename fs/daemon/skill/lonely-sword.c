...
string *parry_msg=({
 ...
 string *array_msg=
    ({
      "[1;33m$N大喝一聲, 腳踏七星, 帶領著眾劍士,展開獨孤破邪劍陣。\n[0m",
      "[1;33m眾人腳踩八卦, 劍化兩儀, 團團將敵人圍住, 令敵人望之膽怯。\n[0m",
      "[1;33m$N急吸一口氣, 帶領眾人加速運轉獨孤鎮邪劍陣,打的敵人手足無措。\n[0m",
     }); 
mapping *action = ({
        ([
                "action"     :               "$N左手捏個劍訣, 平推而出,訣指上仰, 右手劍朝天不動, 正是一招[1;37m『[1;34m震劍勢[1;37m』[0m",
                "dodge"      :                -20,
                "damage"     :                200,
                "post_action":                (: berserk :),
                "damage_type":                "割傷",
         ...
         ([
                "action"     :                "$N面露微笑, 仰視蒼天,使出劍招之極致[1;37m『閃[1;31m劍[1;37m勢』[0m, 但見劍光閃閃",
                "dodge"      :                -10,
                "damage"     :                220,
                "post_action":                (: berserk :),
                "damage_type":                "割傷",
        ...
        ([
                "action"     :               "$N左手持劍, 右手捏個劍訣,雙手成環, 緩緩抬起, 這是[1;37m獨孤劍式絕式[0m的起手式",
                "dodge"      :                -10,
                "damage"     :                700,
                "post_action":                (: sp2 :),
                "damage_type":               "刺傷",
        ...
        ([
                "action"     :
"$N施展出[1;37m獨孤九劍[0m之精妙絕招\n劍招忽變, 飄逸無倫,歪歪斜斜的使出一招[1;37m『落[1;36m劍[1;31m勢[1;37m』[0m",
                "dodge"      :                -10,
                "damage"     :                800,
                "damage_type":               "刺傷",
        ]),
        ([
                "action"     :
"$N施展出[1;37m獨孤九劍[0m之精妙絕招\n劍芒吞吐, 電閃星飛,一招[1;37m『[1;35m旋劍勢[1;37m』[0m, 推送而上",
                "dodge"      :                -10,
                "damage"     :                700,
                "damage_type":               "刺傷",
        ]),
        ([
                "action"     :
"$N施展出[1;37m獨孤九劍[0m之精妙絕招\n$N$w越使越快, 突然間轉過身來,一聲呼喝,唰的一劍, 在$n胸前對穿而過,這一招[1;37m『[1;34m離[1;37m劍[1;34m勢[1;37m』[0m,正是絕高的絕技",
                "dodge"      :                -10,
                "damage"     :                750,
                "post_action":                (: sp4 :),
                "damage_type":               "刺傷",
...
void sp1(object me, object victim, object  weapon, int damage)
{
   ...
   message_vision("[1;37m$N[1;37m長嘯道:『劍旋離身，劍嘯震山河』, 瞬間劍芒大作,朝$n[1;37m激射而至[0m\n",me,victim);
...
{
   int skill= me->query_skill("lonely-sword", 1);
   message_vision("[1;37m$N[1;37m突然悟出『練精化氣, 練氣化神, 練神還虛』之真理, 手中長劍突然消失, 已朝$n[1;37m飛至[0m\n",me,victim);
   victim->add("kee",-(skill* 2));
   COMBAT_D->report_status(victim, 1);
   victim->start_busy(1);
}
...
{
   int skill= me->query_skill("lonely-sword", 1);
   message_vision("[1;37m這起手式一展,跟著劍氣突爆『盪劍．撩劍．過劍．挫劍．離劍．落劍．旋劍．挪劍』,最後雙手同時畫圓, 復成持劍歸原之姿[0m\n",me,victim);
   victim->add("kee",-(skill* 2));
   COMBAT_D->report_status(victim, 1);
   victim->start_busy(1);
}
void sp4(object me, object victim, object  weapon, int damage)
{
   ...
   if( !me->query("berserk") && random(me->query("combat_exp")) > random(victim->query("combat_exp")))
   {
      ...
      message_vision("[1;37m$N[1;37m了悟了『劍在神先, 綿綿不絕』之真意, 劍尖瞬間爆出無數大大小小, 正反斜直各種各樣的圓圈, 朝$n[1;37m直撲而來[0m\n",me,victim);
      for( i= 0; i< loop; i++)
      {
         message_vision("[1;34m$N[1;34m大聲喝道『劍在神先, 綿綿不絕』, 劍招連綿不絕的朝$n[1;34m攻去[0m\n", me, victim);
         victim->add("kee", -( random( skill)));
         COMBAT_D->report_status(victim, 1);
      }
      me->delete_temp("berserk");
      message_vision("[1;31m一陣連擊攻之後, $N[1;31m微感內息不順,趕緊趁機調息。[0m\n",me);
      me->start_busy(1);
      me->add("force", -skill);
   }
}
   ...
   if( random(8) > 3 )
   {
      if( (int)me->query_skill("lonely-sword",1) > random(60)+35 &&me->query("force_factor")>= random(5) && me->query("force")>30)
      {
         if(!me->query_temp("berserk" ))
         {
            ...
            {
               message_vision( sprintf("\n[1;37m$N[1;37m突然頓悟了『神與意合, 意與神守』之意境"+
               "使出獨孤九劍至極之劍術[31m『 蕩劍起～撩劍破～旋劍無極』[37m!!![0m\n"),me ,victim);
               message_vision(sprintf("\n[1;34m$N[1;34m剎那間整個人脫胎換骨變得威猛無倫, "+
...
{
tell_object(me,"[1;34m由於你潛心學習，你的獨孤九劍更加純熟了！！[0m\n");
}
