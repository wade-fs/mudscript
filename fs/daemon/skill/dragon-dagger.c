...
mapping *action = ({
([  "action"      :     "$N一招" + HIW + "『" + HIM + "盤龍出谷" + HIW + "』" + NOR + "﹐手中$w往外劃出﹐向$n直衝而來。",
    "dodge"       :     -20,
    "damage"      :     100,
    "damage_type" :     "刺傷",
    "post_action":      (:call_other,__FILE__,"damage_weapon":),
]),
([  "action"      :     "$N手中$w一挺出﹐一招" + HIW + "『" + HIM + "龍奔四海" + HIW + "』" + NOR + "如狂龍班往$n刺去。",
    "dodge"       :     -30,
    "damage"      :     150,
    "damage_type" :     "刺傷",
    "post_action":      (:call_other,__FILE__,"damage_weapon":),
]),
([  "action"      :     "$N一招" + HIW + "『" + HIM + "強龍併肩" + HIW + "』" + NOR + "將手中$w往$n鄭去﹐隨即飛身踢去﹐並接回$w。",
    "damage"      :     200,
    "dodge"       :     -40,
    "parry"       :     -30,
    "force"       :     100,
...
([  "action"      :     "$N使出" + HIW + " 盤龍匕法 之 『 困 』字訣" + NOR + ",以守帶攻的向$n襲去。",
    "damage"      :     160,
    "damage_type":      "刺傷",
    "post_action" :  (: sp1 :),
]),
([  "action"      :     "$N使出" + HIW + " 盤龍匕法 之 『 生 』字訣" + NOR + ",以守帶攻的向$n襲去。",
    "damage"      :     140,
    "damage_type":      "刺傷",
    "post_action" :  (: sp2 :),
]),
