...
string *dodge_msg =
({
"$n展開[1;36m『凌波微步』[0m﹐左足跨出﹐既踏[1m「中孚」[0m﹐立轉[1m「既濟」[0m﹐[1;33m「神光離合﹐乍陰乍陽」[0m﹐斜斜的躲過$N。\n",
"只見$n施展[1;36m『凌波微步』[0m﹐甫上[1m「泰」[0m位﹐一個轉身﹐右腳踏上[1m「蠱」[0m位﹐[1;33m「體迅飛鷲﹐飄忽若神」[0m﹐反而繞到$N身後。\n",
"$n踏出[1;36m『凌波微步』[0m﹐足下自然而然自[1m「井」[0m位斜行﹐踏到了[1m「訟」[0m位﹐[1;33m「涑輕軀以鶴立﹐若將飛而未翔」[0m﹐輕輕鬆鬆地躲過$N的招式。\n",
"$n使出[1;36m『凌波微步』[0m﹐自[1m「豫」[0m位踏[1m「觀」[0m位﹐[1;33m「翩若驚鴻﹐婉若遊龍」[0m﹐閃身從$N身旁繞過。\n",
"$n展現[1;36m『凌波微步』[0m﹐跟著斜踏[1m「蠱」[0m位﹐[1;33m「忽焉縱體﹐以遨以嘻」[0m﹐身子輕輕飄了開去。\n",
"$n斜踏[1;36m『凌波微步』[0m﹐忽高忽低﹐有若[1;33m「髣彿兮若輕雲之蔽月﹐飄飄兮若流風之回雪」[0m般。\n",
});
