...
mapping *action = ({
        ([      "action":               "$N使一招「天女攔花捧」﹐手中$w使將出來劍光有如一花籃般, 向$n的$l疾馳而下",
                "dodge":                -20,
                "damage":               30,
                "damage_type":  "刺傷"
        ]),
        ([      "action":               "$N使出天女散花劍法中的「天女嚶嚶」﹐劍光霍霍, 忽緩忽快地刺向$n的$l",
                "dodge":                -20,
                "damage":               40,
                "damage_type":  "割傷"
        ]),
        ([      "action":               "$N一招「天女獻花」﹐身形陡然跪倒在地﹐手中$w順勢斬向$n的$l",
                "dodge":                -30,
                "damage":               20,
                "damage_type":  "割傷"
        ]),
        ([      "action":               "$N手中$w中宮直進﹐一式「千嬌百媚」對準$n的$l刺出一劍",
                "dodge":                -40,
                "damage":               50,
                "damage_type":  "刺傷"
        ]),
        ([      "action":               "$N縱身一躍﹐便是一招「春光無限」, $w對準$n的$l送出一劍",
                "dodge":                -40,
                "damage":               45,
                "damage_type":  "刺傷"
        ]),
        ([      "action":               "$N將手上的$w拋向地上﹐雙臂環抱$n, 待$w一落地起腳一踏, 來招乃是「妾意如蠍」, $w直刺$n的$l",
                "dodge":                -20,
                "damage":               50,
                "damage_type":  "刺傷"
        ]),
        ([      "action":               "$N手中$w向外一分﹐使一招「反覆無情」反手對準$n$l一劍刺去",
                "dodge":                -20,
                "damage":               55,
                "damage_type":  "刺傷"
        ]),
        ([      "action":               "$N橫劍上前﹐身形一轉手中$w使一招「散花如夢」畫出一道光弧斬向$n的$l",
                "dodge":                -30,
                "damage":               60,
                "damage_type":  "割傷"
        ]),
...
\t逐步將〔玉女劍法的精髓〕融會貫通, 所以一出手就是六式或七式合一的招式, \n
\t一招一式遞向$n$l\n",
                "dodge"      :               -35,
                "parry"      :               -45,
                "damage"     :                90,
        ...
        ([      "action": "    由於敵人的武學也不弱，急於取勝的心理作用下!$N只好使出玉女劍法的高級劍招!\n
\t\t\t\t『蛇蠍美人心』\n
\t$N幻化出無一時之間, 劍光霍霍, 如同天女下凡一般, 令$n眼花撩亂!!!\n",
                "parry":             -60,
                "dodge":             -60,
                "force":          350,
                "damage":         150,
