...
void sp2(object me,object victim, object weapon, int damage)
{
	...
	return notify_fail(HIR"你使出了七奇秘針之第二式之後，由於竭盡內力，竟無力再使！\n"NOR);
        ...
        victim->apply_condition("cold", random(20)+5);
        victim->apply_condition("star-stial", random(15)+3);
        victim->add("force",-1* random(mforce));
