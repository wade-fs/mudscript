...
$N大水似浪潮般地打向$n！！
$n驟時發覺身上毫無力氣，竟然是傳說中水淹五萬大軍的『猛  水  計』!
LONG + NOR , me , all[i] );
        all[i]->add( "force" ,-k*2);
            me->add("force",k*2/5);
        ...
        message_vision( HIR + @LONG
$N大水似浪潮般地打向$n！！
$n驟時發覺身上毫無力氣，竟然是傳說中水淹十萬大軍的『困  水  計』!
LONG + NOR , me , all[i] );
        all[i]->add( "force" ,-k*3);
            me->add("force",k*3/5);
        COMBAT_D->report_status( all[i] );
        ...
        message_vision( HIR + @LONG
$N大水似浪潮般地打向$n！！
$n驟時發覺身上毫無力氣，竟然是傳說中水淹三十萬大軍的『惡  水  計』!
LONG + NOR , me , all[i] );
        all[i]->add( "force" ,-k*4);
            me->add("force",k*4/5);
        COMBAT_D->report_status( all[i] );
        ...
        message_vision( HIR + @LONG
$N大水似浪潮般地打向$n！！
$n驟時發覺身上毫無力氣，竟然是傳說中水淹五十萬大軍的『水淹荊州城』!
LONG + NOR , me , all[i] );
            me->add("force",k*5/5);
        all[i]->add( "force" ,-k*5);
        COMBAT_D->report_status( all[i] );
        ...
        message_vision( HIR + @LONG
$N大水似浪潮般地打向$n！！
$n驟時發覺身上毫無力氣，竟然是傳說中水淹一萬大軍的『臨  水  計』!
LONG + NOR , me , all[i] );
            me->add("force",k/5);
        all[i]->add( "force" ,-k);
        COMBAT_D->report_status( all[i] );
