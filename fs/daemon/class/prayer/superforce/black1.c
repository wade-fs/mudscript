...
int perform(object me, object target)                                           
{
    ...
    if( hurt_value > 600) hurt_value=600;
        ...
        if(lv1<30)
  return notify_fail("你的[30m玄混沌[0m練的不夠純熟﹐須要玄混沌 30 級。\n");
        ...
        {                                                                       
            ...
            return notify_fail("你不空手是無法使用[30m混沌天爆拳[0m的!\n");                      
        }
        ...
        {                                                                       
            tell_object(me,"[30m混沌天爆拳[0m唯在戰鬥中才能使用。\n");
            return 1;
        }                                                                       
        message_vision("\t$N體內的真氣有如盤古開天地一般，真氣亂竄，\n\t$N依照渾天寶鑑所記載的練功\口訣將此一氣勁融入本身的內力修為之中!!\n\t內功\瞬時暴增了數十倍!!\n",me,target);
        message_vision("$N內勁狂吐﹐雙拳漫佈混沌氣勁，一招[30m混沌天爆拳[0m瞬時向四方炸射開來 ﹗\n",me,target);
                                                                                
        me->add("kee",-hurt_value/10);
        me->add("force",-hurt_value);
        if(80 > random(100))
        {                                                                       
        message_vision("$n被你的[30m混沌天爆拳[0m砸中後，$n全身的經脈被混沌內勁所傷，拳勁透身而出！﹗\n",me,target); 
        ...
        {                                                                         
        message_vision("$n身形急轉，盡鼓全身氣勁，化解了[30m混沌天爆拳[0m的衝擊力 .。\n",me,target);
        message_vision( NOR,me);                                        
