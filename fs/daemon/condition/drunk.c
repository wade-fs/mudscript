// drunk.c
//強化針對玩家的判斷 與補上receive_damage的傷害者參數為自己 by blazakira 2011/6/13
...
int update_condition(object me, int duration)
{
	...
	limit = (me->query_con() + (int)me->query("max_force") / 50) * 2;
	...
	if( !duration ) {
	  message_vision("$N看來酒意全消，睜開眼睛醒了過來。\n", me);
	  return 0;
	}
	return 1;
}
