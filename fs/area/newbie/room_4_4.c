...
void create() {
    ...
    set("no_combat", 1);
    set("coordinate", ({ 4, 4, 0 }));
    set("exits/" + "north", "./room_4_5.c");
    set("exits/" + "south", "./room_4_3.c");
    set("exits/" + "west", "./room_3_4.c");
    set("exits/" + "east", "./room_5_4.c");
    set("exits/" + "lm", "/area/lm/center_world.c");
