...
void create() {
    ...
    set_has_guild(1);
    set_is_outdoor(0);
    set("coordinate", ({ 4, 5, 0 }));
    set("exits/" + "east", "./room_5_5.c");
    set("exits/" + "west", "./room_3_5.c");
    set("exits/" + "north", "./room_4_6.c");
    set("exits/" + "south", "./room_4_4.c"); // 連接中央廣場
    set("exits/" + "lm", "/area/lm/guild_world.c");
