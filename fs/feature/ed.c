// /feature/me.c
//
// Kenny@Eternal.Civilization (3/25/1998)
...
#define LOGFILE	"MODIFICATION"		// 檔案異動記錄檔
...
A  Ctrl-A    將游標移到行首               B  Ctrl-B    往上捲一頁（22 行）\r
E  Ctrl-E    將游標移到行尾               F  Ctrl-F    往下捲一頁（22 行）\r
...
private varargs void _message(object pl, string str, string callback, int hide, mixed arg)
{
        ...
        input_to(callback, 0, hide, pl, arg); // 讀取輸入資料
} // _message()
